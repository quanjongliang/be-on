...
export class daszcxv1643007984012 implements MigrationInterface {
    name = 'daszcxv1643007984012'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deletedAt" TIMESTAMP, "username" character varying NOT NULL, "email" character varying, "isActive" boolean NOT NULL DEFAULT false, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "avatarUrl" character varying, "avatarKey" character varying, "password" character varying NOT NULL, "refreshToken" character varying, "status" character varying NOT NULL DEFAULT 'online', "message" character varying NOT NULL DEFAULT '', "currentGangId" character varying, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "gang_member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deletedAt" TIMESTAMP, "valid" boolean NOT NULL DEFAULT false, "role" character varying NOT NULL DEFAULT 'member', "gangId" uuid, "userId" uuid, CONSTRAINT "PK_749552726c5b946f7c9d1ffa611" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "gang" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "avatarUrl" character varying, "avatarKey" character varying, "ownerId" uuid, CONSTRAINT "UQ_c5c09d967359a7a5de838ffaf64" UNIQUE ("name"), CONSTRAINT "PK_1bb95b1060d699216e8472429f3" PRIMARY KEY ("id"))`);
